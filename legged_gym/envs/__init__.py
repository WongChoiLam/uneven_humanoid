...
from legged_gym.envs.g1.g1_full_dof_config import G1FullDOFCfg, G1FullDOFPPO
from legged_gym.envs.g1.g1_full_dof_env import G1FullDOFRobot
...
task_registry.register("g1_full_dof", G1FullDOFRobot, G1FullDOFCfg(), G1FullDOFPPO())
